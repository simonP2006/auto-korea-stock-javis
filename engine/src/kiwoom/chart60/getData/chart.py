...
from src.kiwoom.chart60.getData.models import DailyCandle, MinuteCandle
...
_BARS_PER_DAY_60M: Final[int] = 8  # 정규장 6.5h + 여유
_DAILY_MIN_ROWS_DEFAULT: Final[int] = 330  # MA306 산출 + 휴장일 마진
_MINUTE_BARS_DEFAULT: Final[int] = 16  # 가장 최근 60분봉 행 수 기본
...
class ChartService:
    ...
    async def fetch_minute_60(
        ...
        *,
        ...
        이면 ``bars=16`` (가장 최근 60분봉 16개)이 적용된다. 둘 다 지정하면
        ``ValueError`` 를 발생시킨다.
        ...
        if bars is not None:
            ...
            target_rows = days * _BARS_PER_DAY_60M
